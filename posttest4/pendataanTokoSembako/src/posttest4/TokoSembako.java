...
public class TokoSembako {
    ...
    TokoSembako(String namaBrg, String satuan, int stokAwal, int stokMasuk, int stokKeluar, int hargaBeli, int hargaJual, long noKodeBrg){
    ...
    TokoSembako TB;
    ArrayList<TokoSembako> TBList = new ArrayList<>();
    ...
    public ArrayList<TokoSembako> ubahBarang(ArrayList<TokoSembako> TBList) {
        return TBList;
    }
    public ArrayList<TokoSembako> hapusBarang(ArrayList<TokoSembako> TBlist) {//OVERLOADING 1
        System.out.println("\nMenghapus Produk\n");
        return TBlist;
    }
