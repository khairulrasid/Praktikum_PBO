...
public class BrgSembako extends TokoSembako{
   private final String kodeBrg = "Brg";
    ...
    BrgSembako Brg;
    ArrayList<TokoSembako> BrgList = new ArrayList<>();
    ...
    public void tambahBarang () {
        boolean ulang=true;
        System.out.println("\t|==================================================|");
        System.out.println("\t|               TAMBAH SEMBAKO                     |");
        System.out.println("\t|==================================================|");
        System.out.print("Nama Sembako : ");
    ...
    public void tampilBarang(){
        System.out.println("\t|==================================================|");
        System.out.println("\t|               TAMPIL SEMBAKO                     |");
        System.out.println("\t|==================================================|");
    ...
    public ArrayList<TokoSembako> ubahBarang(ArrayList<TokoSembako> Brglist)  {
        int ubah;
        System.out.println("\t|==================================================|");
        System.out.println("\t|               UBAH SEMBAKO                       |");
        System.out.println("\t|==================================================|");
        for (int i=0; i<BrgList.size(); i++){
    ...
    @Override
    public ArrayList<TokoSembako> hapusBarang(ArrayList<TokoSembako> Brglist) {
        System.out.println("\t|==================================================|");
        System.out.println("\t|               HAPUS SEMBAKO                      |");
        System.out.println("\t|==================================================|");
        for (int i=0; i<BrgList.size(); i++){
            System.out.println("No Kode Barang : " + kodeBrg +
            BrgList.get(i).getNoKodeBrg());
        ...
        System.out.println("\n>> Data Sembako Berhasil di Hapus <<\n");
        return BrgList;
    }
